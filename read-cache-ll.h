...
#define REFRESH_IGNORE_UPDATE_PLACEHOLDER  (1 << 8) /* do not refresh placeholder state */
#define REFRESH_IGNORE_HYDRATE_PLACEHOLDER (1 << 9) /* do not hydrate placeholder entries */
